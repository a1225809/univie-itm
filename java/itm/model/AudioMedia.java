...
public class AudioMedia extends AbstractMedia {
	...
	protected String encoding = "no data available";
	protected long duration;
	protected String author = "no data available";
	protected String title = "no data available";
	protected Date date;
	protected String comment = "no data available";
	protected String album = "no data available";
	protected String track = "no data available";
	protected String composer = "no data available";
	protected String genre = "no data available";
