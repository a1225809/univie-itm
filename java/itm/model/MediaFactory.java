...
public class MediaFactory {
	...
	protected static ArrayList<AbstractMedia> loadMedia() throws IOException {
		...
		itg.batchProcessImages(imageDir, metadataDir, 200, 100, false);
		...
		vtg.batchProcessVideoFiles(videoDir, metadataDir, false);
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length < 4) {
			System.out
					.println("usage: java itm.model.MediaFactory <image-directory> <audio-directory> <video-directory> <metadata-directory>");
			System.exit(1);
		}
