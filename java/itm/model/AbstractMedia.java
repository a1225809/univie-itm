...
/**
    This class describes an abstract media object. 
    It stores a reference to the wrapped media file in its "instance" property and may hold 
    metadata associated to this media object like semantic tags or similar.
*/
public abstract class AbstractMedia {
    ...
    */
    ...
    /**
        A list of "semantic tags" (in this simple implementation, a list of Strings)
    */
    ...
    */
    ...
    /**
        Constructor.
        @param instance a reference to the media file.
    */
    ...
    */
    ...
    /**
        Removes the passed tag from the list of tags associated to this media object.
    */
    ...
    /**
        @return the name of the media object (if not set, the name of the instance file is returned or null if not available)
    */
